...
if (spec == 'y')
{
  ...
  inputTag.setAttribute("style", "position:fixed; z-index:9999; cursor: pointer; outline: none; bottom:76px; font-size:20px; right:20px; margin: 5px;padding:5px; border: none; font-weight:bold; background: url(/js/eye/eye.png) no-repeat; background-size:cover; width:100px; height:73px; " );
 inputTag.value="";
