        ...
        <div class="row">
            <div id="place-block" class="col-lg-4 col-sm-12">
                <p class="text-center"><i
                            class="icon icon-place"></i> <?= Html::a('г. Москва, ул. Лестева, д.20', HelperPages::getUrlByLayout(HelperPages::LAYOUT_CONTACT)) ?>
                </p>
            </div>
            <div id="time-block" class="col-lg-4 col-sm-12">
                <p class="text-center"><i
                            class="icon icon-time"></i> <?= Html::a('Время работы центров', '/site/work-time', ['onclick' => 'workTime(this,event)']) ?>
                </p>
            </div>
            <div class="col-lg-4 col-sm-12">
                <div id="wrap-search-form">
                    <form class="text-right" action="<?= Yii::$app->urlManager->createUrl(['/site/search']) ?>"
                          method="GET">
                        <button class="btn-search" type="submit"><i class="icon icon-search"></i></button>
                        <input class="text-search" name="query" type="text" placeholder="Поиск по сайту"
                               aria-label="Поиск по сайту" value="<?= isset($_GET['query']) ? $_GET['query'] : '' ?>">
                    </form>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-5 deport-list">
            <div class="row">
                ...
                <div class="col-7 text-right">
                    ...
                    <?= Html::a('Записаться', ['/site/contact-form?goal=submitRecord'], [
                        'class' => 'maa-link',
                        'data-goal' => 'clickRecord',
        ...
        <div class="col-lg-2 col-12">
            <div style="text-align: right;">
                ...
                <?= Html::a('Обратная связь', ['/site/contact-form?goal=submitFeedBack'], [
                    'class' => 'feedback-link',
                ...
                <div class="header-social">
                    <noindex>
                        ...
                        <a target="_blank" href="https://www.facebook.com/ma.zdorovoepokolenie"><img
                                    src="/imgs/social_fb.png"/></a>
                        <a target="_blank" href="https://www.instagram.com/medcentrmazp/"><img
                                    src="/imgs/social_inst.png"/></a>
                        <a target="_blank" href="https://www.youtube.com/channel/UCp8Z-38A50rN7Q2-yQNdBlQ"><img
                                    src="/imgs/social_youtube.png"/></a>
                    </noindex>
                </div>
            </div>
        </div>
...
<div class="container">
    ...
    <div class="main-widget-deports">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="depart-item">
                    <div class="deport-map">
                        <a href="https://www.google.ru/maps/place/%D1%83%D0%BB.+%D0%9B%D0%B5%D1%81%D1%82%D0%B5%D0%B2%D0%B0,+20,+%D0%9C%D0%BE%D1%81%D0%BA%D0%B2%D0%B0/@55.714892,37.610076,17z/data=!3m1!4b1!4m2!3m1!1s0x46b54b6b9b09f853:0xbb64e121c13ccf36"><img
                                    src="/imgs/Lesteva20.jpg"/></a>
                    </div>
            ...
            <div class="col-md-4">
                <div class="depart-item">
                    <div class="deport-map"><a
                                href="https://www.google.ru/maps/place/%D0%A4%D0%BE%D1%82%D0%B8%D0%B5%D0%B2%D0%BE%D0%B9+%D1%83%D0%BB.,+6,+%D0%9C%D0%BE%D1%81%D0%BA%D0%B2%D0%B0/@55.701753,37.563137,17z/data=!3m1!4b1!4m2!3m1!1s0x46b54c841475d615:0xcffb978b68645aa7"><img
                                    src="/imgs/Fotievoy6.jpg"/></a></div>
    ...
    <div class="row social-wrap">
        <div class="col-md-4">
            ...
            <div class="feedback-form">
                <?= \app\widgets\ReviewsWidget\ReviewsFormWidget::widget(['view' => 'form', 'goal'=>'formFaq']) ?>
            </div>
        </div>
        <div class="col-md-4">
    ...
    <div class="row main-widget-footer">
        ...
        <div class="col-md-4">
            ...
            <div class="main-widget-footer-content">
                <p>Необходимо проконсультироваться с врачом Вся информация на сайте является справочной и не является
                    открытой офертой</p>
                <p>Перед применением проконсультируйтесь со специалистом. Политика компании в отношении <a href="#">обработки
...
<footer class="footer">
    <div class="container">
        <span class="text-center"><?php echo date("Y"); ?> © Медцентр «Здоровое поколение»</span>
        ...
        <noscript>
            <div><img src="https://mc.yandex.ru/watch/7736377" style="position:absolute; left:-9999px;" alt=""/></div>
        </noscript>
        <!-- /Yandex.Metrika counter -->
    </div>
</footer>
