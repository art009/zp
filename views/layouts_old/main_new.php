...
<script>
  ...
  fbq('init', '357138791762267');
  fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
  src="https://www.facebook.com/tr?id=357138791762267&ev=PageView&noscript=1"
/></noscript>
    ...
    <div id="top-line" class="container">
        <div class="row">
            ...
            <div id="time-block" class="col-lg-4 col-sm-12">
                <p class="text-center"><i class="icon icon-time"></i> <?=Html::a('Время работы центров','#',['onclick'=>'workTime(this,event)', 'data-href'=>'/site/work-time'])?></p>
            </div>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-lg-2 col-12 text-right">
            <?=Html::a('Записаться',['/site/contact-form','sourch' => 'site','text' => 'Записаться к врачу'], [
                'class'=> 'maa-link',
                'data-title'=>'Записаться к врачу',
                'onclick'=>'callContactForm(this,event)',
                'data-goal' => 'submitRecord',
            ])?><br/>
            <?=Html::a('Обратная связь',['/site/contact-form','sourch' => 'site','text' => 'Напишите нам'],[
                'class'=> 'feedback-link',
                'data-title'=>'Напишите нам',
                'onclick'=>'callContactForm(this,event)',
				'data-goal' => 'submitFeedBack',
            ])?><br/>

            <div class="header-social">
                <noindex>
                    <a target="_blank" href="https://vk.com/medcentrmazp"><img src="/imgs/social_vk.png"/></a>
                    <a target="_blank" href="https://www.facebook.com/MedCentrMaZp/"><img src="/imgs/social_fb.png"/></a>
    ...
    <div class="row social-wrap">
        <div class="col-md-4">
            ...
            <div class="feedback-form">
                <?=\app\widgets\ReviewsWidget\ReviewsFormWidget::widget(['view' => 'form','goal' => 'submitTestimonial'])?>
            </div>
        </div>
        <div class="col-md-4">
...
<footer class="footer">
    <div class="container">
        <span class="text-center"><?=date('Y')?> © Медцентр «Здоровое поколение»</span>
