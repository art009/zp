...
$this->params['breadcrumbs'][] = [
	'label' => 'Все статьи',
	'url' => Pages::getUrlByLayout(Pages::LAYOUT_ARTICLE_LIST),
];
...
<div class="container">
	<div class="row">
		...
		<div class="col-lg-2">
			<p class="text-rigth mt-4"><?=Html::a('Все статьи',Pages::getUrlByLayout(Pages::LAYOUT_ARTICLE_LIST),['class'=>'btn-list'])?></p>
		</div>
